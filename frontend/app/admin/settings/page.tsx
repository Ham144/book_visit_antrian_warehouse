                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-teal-600 bg-teal-50 p-2 rounded">
                      <span className="font-medium">Penjelasan:</span> Interval
                      (menit) untuk menjaga jarak dengan booking dengan status
                      IN_PROGRESS sebelumnya, jika 0 maka auto
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-teal-600 bg-teal-50 p-2 rounded">
                      ...
                      admin vendor dan admin gudang boleh memilih waktu spesifik
                      (false) atau auto smart berdasarkan ujung booking terakhir
                      atau ujung busy time atau awal dari hari kerja (vacant
                      time start).
                    </div>
                  </div>
                  {/* Auto efficient Click */}
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-teal-600 bg-teal-50 p-2 rounded">
                      ...
                      nilai maximumWeekSelection adalah 1 maka hanya hari senin
                      ini dan minggu esok yang bisa.
                    </div>
                  </div>
                </div>
              </div>
